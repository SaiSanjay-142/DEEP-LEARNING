...
# Predict bird species from a given audio file using MobileNetV2 model
# ========================================================
...
# ------------------- Config -------------------
MODEL_NAME = r"D:\Projects\Bird sound detector\MobileNetv2\bird_sound_mobilenetv2.h5"
LABELS_CSV = r"D:\Projects\Bird sound detector\MobileNetv2\label_mapping_mobilenet.csv"
IMG_SIZE = 128
SECONDS = 5.0
SR = 22050
MAX_FRAMES = IMG_SIZE
...
def audio_to_mel(path, sr=SR, seconds=SECONDS, n_mels=IMG_SIZE, max_frames=MAX_FRAMES):
    ...
    try:
        ...
        return np.array([mel_3ch], dtype=np.float32)
...
if __name__ == "__main__":
    audio_file = r"D:\Projects\Bird sound detector\MobileNetv2\cuckoo-sound-effect-01-326777.mp3"
